...
struct compiler_unit {
    ...
    */
    ...
    PyObject *u_cellvars;  /* cell variables 内部嵌套所引用的局部变量*/
    PyObject *u_freevars;  /* free variables 闭包需要的东西*/

    PyObject *u_private;   /* for private name mangling 这个相当于c++ 重载需要重命名一样的道理 python的类中 私有成员需要重命名*/
...
/* compiler_addop_o  这个代表添加object和指定码 i代表instrment */
static int
...
compiler_mod(struct compiler *c, mod_ty mod)
{
    ...
    /*assemble(c, addNone)，它是将前面生成好的opcode等数据转换成最终的bytecode*/
